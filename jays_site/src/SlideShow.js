...
const currentObj = this.props.currentObj;
  ...
  export default class SlideShow extends React.Component {
    ...
    render() {
        ...
        >
          <SwiperSlide><img alt={"need to add text here"} src={currentObj.carousel[0].slide}/></SwiperSlide>
          <SwiperSlide><img alt={"need to add text here"} src={currentObj.carousel[1].slide}/></SwiperSlide>
          <SwiperSlide><img alt={"need to add text here"} src={currentObj.carousel[2].slide}/></SwiperSlide>
